...
wywo³ania przy u¿yciu jêzyku XML) UserLand Software. Frontier::RPC
zawiera zarówno modu³ kliencki do wysy³ania ¿±dañ do serwera, a tak¿e
kilka modu³ów serwerowych do implementowania serwerów przy u¿yciu CGI,
Apache'a, a tak¿e samodzielnie z u¿yciem HTTP::Daemon.
